...
export default function Contact() {
  return (
    <div
      className="contact-page container py-5"
      style={{ paddingTop: "100px" }}
    >
      <div className="text-center mb-5">
        <h2 className="fw-bold text-danger">Contact Us</h2>
        <p className="text-muted mx-auto" style={{ maxWidth: "600px" }}>
          Have any questions or ideas? We'd love to hear from you! Fill out the
        ...
        <div className="col-12 col-sm-10 col-md-8 col-lg-6">
          <form className="p-4 border rounded-4 shadow-sm bg-light">
            ...
            <div className="text-center">
              <button
                type="submit"
                className="btn btn-danger px-4 fw-semibold w-100 w-sm-auto"
              >
                Send Message
              </button>
            </div>
      ...
      <div className="text-center mt-5">
        ...
        <p className="text-muted mb-1">123 Main Street, Cairo, Egypt</p>
